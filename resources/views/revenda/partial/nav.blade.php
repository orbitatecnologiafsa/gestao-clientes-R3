<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo me-5" href="{{ route('revenda-dashboard')}}">{{--<img id="logo-nav-licenca" src="{{ asset('images/auth/liecenca-logo.jpg')}}" class="me-2"
                alt="logo" /> --}} 
                <span class="nav-link" style="padding-left: 30px;"> Orbita Tecnologia</span> </a>
              </a>
        <a class="navbar-brand brand-logo-mini " href="{{ route('revenda-dashboard')}}"><img class="img rounded-circle" style="" src="{{ asset('images/auth/logo.jpg')}}" alt="logo" /></a>
    </div>
          ...
          <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="notificationDropdown">
            ...
            <li class="nav-item nav-profile dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
                    <a class="dropdown-item" href="{{ route('revenda-usuario-detalhes',Auth::user()->id)}}">
