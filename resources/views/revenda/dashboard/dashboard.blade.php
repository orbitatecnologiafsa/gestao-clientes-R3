...
@section('conteudo')
    ...
    <div class="row">
        ...
        <div class="col-md-3 grid-margin stretch-card">
            ...
            <div class="card">
                <a class="nav-link" style="color: black" href="{{route('revenda-cliente-lista') }}">
                <div class="card-body">
        ...
        <div class="col-md-3 grid-margin stretch-card">
            <div class="card">
                <a class="nav-link" style="color: green" href="{{route('revenda-cliente-ativos') }}">
                <div class="card-body">
        ...
        <div class="col-md-3 grid-margin stretch-card">
            <div class="card">
                <a class="nav-link" style="color: rgb(255, 123, 35);" href="{{route('revenda-cliente-bloqueados') }}">
                <div class="card-body">
        ...
        <div class="col-md-3 grid-margin stretch-card">
            <div class="card">
                <a class="nav-link" style="color: red;" href="{{route('revenda-cliente-inativos') }}">

                <div class="card-body">
                    <p class="card-title text-md-center text-xl-left">Churn</p>
                    <div
                        class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
        ...
        {{-- vaL{} --}}
            @foreach ($empresas['empresas'] as $emp)
                <div class="col-md-3 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <p class="card-title text-md-center text-xl-left">{{ $emp->nome }}</p>
                            <div
                                class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                                <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0">
                                    <i class="ti-user icon-md text-muted mb-0 mb-md-3 mb-xl-0"></i>
                                    {{ $empresas['qtdClientes'][$emp->nome] }}
                                </h3>
                            ...
                            <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0">
                                <i class="ti-money icon-md text-muted mb-0 mb-md-3 mb-xl-0"></i> <span
                                    style="color:rgb(116, 158, 52);">
                                    {{ number_format($empresas['qtdValor'][$emp->nome], 2, ',', '.') }} </span>
                            </h3>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div
                            ...
                            <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0">
                                ...
                                {{ $empresas['total'] ? number_format($empresas['total'], 2, ',', '.') : 0 }}
                            </h3>
