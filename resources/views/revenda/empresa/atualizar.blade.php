    ...
    <div class="col-12 grid-margin">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-sample" action="{{ route('revenda-empresa-atualizar-id', $empresa->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="documento"
                                        value="{{ old('documento') ?? $empresa->documento }}" class="form-control" />
                                    @error('documento')
                                        <span class="danger text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="responsavel"
                                        value="{{ old('responsavel') ?? $empresa->responsavel }}" class="form-control" />
                                    @error('responsavel')
                                        <span class="danger text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
