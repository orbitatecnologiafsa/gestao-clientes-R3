...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="row">
            ...
            <form class="form-sample" action="{{ route('adm-cliente-busca-empresa') }}" method="get">
                <div class="col-md-6">
                    <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Buscar cliente cnpj/nome ou status</label>
                    <div class="col-sm-9">
                        <form class="form-sample" action="{{ route('adm-cliente-busca') }}" method="get">
        ...
        <div class="col-md-6">
            <div class="form-group row">
                <div class="col-sm-9">
                    <a type="submit" href="{{ route('adm-cliente-lista') }}"
                            ...
                            <tbody>
                                ...
                                @foreach ($clientes as $cliente)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('adm-cliente-atualizar-id', $cliente->id) }}"
                                                class="btn btn-primary">Atualizar</a>
                                            <a href="{{ route('adm-cliente-detalhes-id', $cliente->id) }}"
