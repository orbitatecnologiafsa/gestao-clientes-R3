    ...
    <div class="col-12 grid-margin">
        <div class="card">
            <div class="card-body">
                ...
                <a class="btn-primary btn me-2 btn-rounded" href="javascript:history.back()">Voltar</a>
                <a href="{{ route('adm-cliente-atualizar-id',$cliente->id)}}" class="btn-primary btn me-2 btn-rounded">Atualizar</a>
