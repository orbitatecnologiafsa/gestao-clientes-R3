...
<div class="col-12 grid-margin">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form class="form-sample" method="post" action="{{ route('adm-empresa-cadastro-post')}}">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="cidade" value="{{ old('documento')}}" class="form-control" />
                                @error('cidade')
                                <span class="danger text-danger">{{ $message }}</span>
                            @enderror
                            </div>
