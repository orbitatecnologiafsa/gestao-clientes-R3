                        ...
                        <tbody>
                            ...
                            @foreach ($empresas as $empresa)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('adm-empresa-atualizar',$empresa->id)}}" class="btn btn-primary">Atualizar</a>
                                        <a href="{{ route('adm-empresa-detalhes',$empresa->id)}}" class="btn btn-info">Detalhes</a>
                                    </td>
                                </tr>
                            @endforeach
