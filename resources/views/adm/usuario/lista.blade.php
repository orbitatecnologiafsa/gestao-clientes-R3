                        ...
                        <tbody>
                            ...
                            @foreach ($usuarios as $usuario)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('adm-usuario-atualizar',$usuario->id)}}" class="btn btn-primary">Atualizar</a>
                                        <a href="{{ route('adm-usuario-detalhes',$usuario->id)}}" class="btn btn-info">Detalhes</a>
                                    </td>
                                </tr>
                            @endforeach
