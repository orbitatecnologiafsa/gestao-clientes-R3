...
@section('conteudo')
    ...
    <div class="row">
        ...
        <div class="col-md-3 grid-margin stretch-card">
            ...
            <div class="card">
                <a class="nav-link" style="color: black" href="{{route('adm-cliente-lista') }}">
                <div class="card-body">
        ...
        <div class="col-md-3 grid-margin stretch-card">
            <div class="card">
                <a class="nav-link" style="color: green" href="{{route('adm-cliente-ativos') }}">
                <div class="card-body">
        ...
        <div class="col-md-3 grid-margin stretch-card">
            <div class="card">
                <a class="nav-link" style="color: rgb(255, 123, 35);" href="{{route('adm-cliente-bloqueados') }}">
                <div class="card-body">
        ...
        <div class="col-md-3 grid-margin stretch-card">
            <div class="card">
                <a class="nav-link" style="color: red;" href="{{route('adm-cliente-inativos') }}">
