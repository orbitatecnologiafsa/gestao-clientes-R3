...
use App\Http\Requests\Adm\EmpresaRequest;
use App\Repositorio\Adm\EmpresaRepositorio;
...
class EmpresaController extends Controller
{
    ...
    public function deleteId($id)
    {
       ...
       if($this->empresaRepositorio->deletarId($id)){
        return redirect()->route('adm-empresa-lista')->with('msg-success','Empresa excluida com sucesso!');
       }
